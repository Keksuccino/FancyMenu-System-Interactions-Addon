...
public class CopyFileAction extends Action {
    ...
    public @NotNull Component getActionDisplayName() {
        return Components.translatable("fmsia.actions.copyfile");
    }

    @Override
    public @NotNull Component[] getActionDescription() {
        return LocalizationUtils.splitLocalizedLines("fmsia.actions.copyfile.desc");
    }

    @Override
    public Component getValueDisplayName() {
        return Components.translatable("fmsia.actions.copyfile.desc.value");
    }
