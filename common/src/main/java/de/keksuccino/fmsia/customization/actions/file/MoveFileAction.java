...
public class MoveFileAction extends Action {
    ...
    public @NotNull Component getActionDisplayName() {
        return Components.translatable("fmsia.actions.movefile");
    }

    @Override
    public @NotNull Component[] getActionDescription() {
        return LocalizationUtils.splitLocalizedLines("fmsia.actions.movefile.desc");
    }

    @Override
    public Component getValueDisplayName() {
        return Components.translatable("fmsia.actions.movefile.desc.value");
    }
